...
function LevelOnePage() {
  ...
  const subjects: Subject[] = [
    ...
    {
      id: 'l3-s1-1',
      name: 'Care of Clients with Problems in Oxygenation, Fluid and Electrolyte, Infectious, Inflammatory and Immunologic Response, Cellular Aberration, Acute and Chronic',
      code: 'NP13',
      semester: 'First'
    },
    {
      id: 'l3-s1-2',
      name: 'Care of Older Adult',
      code: 'NP14',
      semester: 'First'
    },
    {
      ...
      code: '', // No code shown in image
      semester: 'First'
    },
    {
      id: 'l3-s1-4',
      name: 'Nursing Entrepreneurship',
      code: '', // No code shown in image
      semester: 'First'
    },
    ...
    {
      id: 'l3-s2-1',
      name: 'Care of Clients with Maladaptive Patterns of Behavior, Acute and Chronic (Psych)',
      code: 'NP17',
      semester: 'Second'
    },
    {
      id: 'l3-s2-2',
      name: 'Care of Clients with Problems in Nutrition, Gastrointestinal, Metabolism and Endocrine, Perception and Coordination (Acute Chronic)',
      code: '', // No code shown in image
      semester: 'Second'
    },
    {
  ...
  const navItemStyle = (isActive: boolean): CSSProperties => ({
    backgroundColor: isActive ? '#19335A' : '#5E90D4',
    color: 'white',
    padding: '30px 20px',
    borderRadius: '25px',
    fontSize: '22px',
  ...
  return (
    <div style={pageContainer}>
      ...
      <aside style={sidebarStyle}>
        <h1 style={{ color: '#214374', fontSize: '28px', fontWeight: 'bold', marginBottom: '30px' }}>
          Flashcards Group
        </h1>
      ...
      <main style={mainContentStyle}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '40px' }}>
          <button
            onClick={() => router.back()}
            style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'none', border: 'none', color: '#214374', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' }}
          >
