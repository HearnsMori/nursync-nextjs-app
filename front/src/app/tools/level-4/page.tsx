...
function LevelOnePage() {
  ...
  const subjects: Subject[] = [
    ...
    {
      id: 'l4-s1-1',
      name: 'Nursing Competency Appraisal',
      code: '',
      semester: 'First'
    },
    {
      id: 'l4-s1-2',
      name: 'Decent Work Employment and Transcultural Nursing and Spirituality',
      code: '',
      semester: 'First'
    },
    {
    ...
    {
      id: 'l4-s1-4',
      name: 'Nursing Care of Clients with Life Threatening Conditions, Acutely Ill/Multi-organ Problems, High Acuity and Emergency Situation, Acute and Chronic',
      code: '',
      semester: 'First'
    },
    ...
    {
      id: 'l4-s2-1',
      name: 'Nursing Competency Appraisal 2',
      code: '',
      semester: 'Second'
    },
    {
      id: 'l4-s2-2',
      name: 'Intensive Nursing Practicum (Hospital and Community Settings)',
      code: '',
      semester: 'Second'
    },
    {
  ...
  const navItemStyle = (isActive: boolean): CSSProperties => ({
    backgroundColor: isActive ? '#40195A' : '#9B6FB3',
    color: 'white',
    padding: '30px 20px',
    borderRadius: '25px',
    fontSize: '22px',
  ...
  return (
    <div style={pageContainer}>
      ...
      <aside style={sidebarStyle}>
        <h1 style={{ color: '#5B2174', fontSize: '28px', fontWeight: 'bold', marginBottom: '30px' }}>
          Flashcards Group
        </h1>
      ...
      <main style={mainContentStyle}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '40px' }}>
          <button
            onClick={() => router.back()}
            style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'none', border: 'none', color: '#5B2174', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' }}
          >
